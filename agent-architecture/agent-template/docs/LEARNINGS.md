...
├── agent-b/learnings    # working branch
├── agent-c/learnings    # working branch
└── agent-a/learnings   # working branch
```

### Commit format

```
[agent-b] Learning #4: don't copy keys between servers
[agent-c] Learning #1: save raw data without asking
```
