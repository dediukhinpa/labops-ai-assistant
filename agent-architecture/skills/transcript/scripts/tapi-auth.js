...
//   4. API key is saved to ~/.claude-lab/your-agent/secrets/transcript-api-key
...
const KEY_REL_PATH = ".claude-lab/your-agent/secrets/transcript-api-key";
...
// Save API key to ~/.claude-lab/your-agent/secrets/transcript-api-key
