...
```bash
# generic web_fetch returns HTML tags, ads, navigation, scripts...
```
...
| Feature | markdown.new | Jina AI Reader | web_fetch (generic) | Cloudflare Markdown |
|---------|--------------|----------------|----------------------|---------------------|
...
**Workarounds:**
- For JavaScript-heavy sites → use a browser-automation skill (`agent-browser`)
...
- **web_fetch:** generic web scraping (more HTML noise)
