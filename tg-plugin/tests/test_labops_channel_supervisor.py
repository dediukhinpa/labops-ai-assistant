...
SUPERVISOR_PATH = REPO_ROOT / "scripts" / "labops-channel-supervisor"


def load_supervisor():
    module_name = "labops_channel_supervisor"
...
class SupervisorTestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.env = {"LABOPS_CHANNEL_RUNTIME_ROOT": str(self.runtime_root)}
    ...
    def test_status_canary_initializes_runtime_without_secret_output(self):
        ...
        self.assertEqual(status["session"], "labops-canary")
    ...
    def test_non_canary_agents_are_rejected_by_the_scaffold(self):
        ...
        code, out, err, runner = self.run_cli(["status", "nova", "--json"], runner)
    ...
    def test_logs_non_canary_error_uses_the_configured_error_stream(self):
        ...
        code, out, err, runner = self.run_cli(["logs", "nova"], runner)
