...
// `AskUserQuestion` tool and routes the prompt through the labops-channel
...
//     }
//
//   POST http://127.0.0.1:6000/hooks/ask-user-question/request
...
//   TELEGRAM_WEBHOOK_URL    e.g. http://127.0.0.1:6000/hooks/ask-user-question/request
...
// 6000) is always added at runtime.
const PORT_HARD_WHITELIST = new Set<number>([6000, 6001, 6002])
const DEFAULT_WEBHOOK_PORT = 6000
...
export function validateLoopbackUrl(
  ...
  // `[::1]` form in our allowlist matches `new URL('http://[::1]:6000')`.
