...
// the labops-channel MCP pushes a notification (`← <channel>: …`). All
...
// (e.g. labops-channel) pushes a notification mid-session — `← <name>:
// <preview>`. The arrow is U+2190; the channel name is a kebab-case
// identifier in our world (`labops-channel`, `labops-inbox`, etc.).
//
...
// «> Что у нас по Labops?» (a quoted reply). Trailing whitespace is
