#!/usr/bin/env bash
# Claude Code PreToolUse hook for multichat-atlas.
#
...
# registered into the master atlas workspace via a stray settings.json) and
...
WORKSPACE="${CLAUDE_WORKSPACE_DIR:-${HOME}/.claude-lab/developer/.claude}"
